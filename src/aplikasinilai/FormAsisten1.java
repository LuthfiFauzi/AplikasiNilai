...
public class FormAsisten1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tanggal.setDoubleBuffered(false);
        tanggal.setMaxSelectableDate(new java.util.Date(253370743286000L));
        tanggal.setMinSelectableDate(new java.util.Date(-62135791114000L));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tanggal Input", "Nama", "NIM", "Asisten Kelompok", "Materi Praktikum", "Nilai"
            }
        ) {
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        // TODO add your handling code here:
        try {
            String sql ="UPDATE halamanasisten SET tanggal_input = '"+tanggal.getDate()+"', nama = '"+txnama.getText()+"', nim = '"+txnim.getText()+"',  asisten_kelompok = '"+txasisten.getText()+"', materi_praktikum = '"+jComboBox1.getSelectedItem()+"',nilai= '"+txnilai.getText()+"' WHERE nim = '"+txnim.getText()+"'";
            java.sql.Connection conn=(Connection)config.configDB();
            java.sql.PreparedStatement pst=conn.prepareStatement(sql);
            pst.execute();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAsisten1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new FormAsisten1().setVisible(true);
        });
    }
